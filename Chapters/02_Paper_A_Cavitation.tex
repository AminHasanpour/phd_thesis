...
\noindent \textbf{Rasmus Engholm}\\
\textit{Grundfos Holding A/S}\\
Bjerringbro, Denmark\\
rasmus.engholm@gmail.com
...
\section{Abstract}\label{sec:paper-a-abstract}
...
% \section*{Keywords}
% Cavitation; Support Vector Machine; Deep Learning; Machine Learning; Centrifugal Pump
...
\begin{sidewaysfigure}
  \centerline{\includegraphics[width=\textwidth]{Pictures/Paper_cavitation/record_samples.pdf}}
    ...
    \label{fig:paper-a-data-examples}
\end{sidewaysfigure}
...
\section{Results}\label{sec:paper-a-results}
...
\begin{table}[htbp]
    ...
    \begin{center}
        ...
        \end{tabular}
        \label{tab:paper-a-data-type-inclusion}
    \end{center}
\end{table}
...
\begin{figure}[t]
    ...
    \label{fig:paper-a-target}
\end{figure}

Based on the default CNN model that we've shown to be successful, we designed several smaller models. Table~\ref{tab:paper-a-cnn-info} contains information of these models and their performance. \textit{CNN\_4} is the default CNN model.
    ...
    \begin{center}
        \begin{tabular}{|l|c|c|c|c|}
            \hline
             ...
             \hline
        \end{tabular}
        \label{tab:paper-a-cnn-info}
    \end{center}
\end{table}

We have deployed the models to a NUCLEO-L4R5ZI board and benchmarked their performance. NUCLEO-L4R5ZI contains an STM32L4R5ZI microcontroller, which is based on an Arm Cortex-M4 core. TFLM is used to port the model to its C++ implementation. In addition to the float32 format, several quantized versions of the models have been tested, namely, dynamic range quantization, int8 quantization, 16x8 quantization, and float16 quantization. Since the most effective quantization method was the int8 quantization, we only report the results of this method and the default float32 format. Table~\ref{tab:paper-a-cnn-performance} contains the benchmarking results of the models.
...
\begin{table}[htbp]
    ...
    \begin{center}
        ...
        \end{tabular}
        \label{tab:paper-a-cnn-performance}
    \end{center}
\end{table}
